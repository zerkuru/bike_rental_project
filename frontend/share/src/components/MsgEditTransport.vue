<template>
  <div>
          ...
          <div class="col-md-3 text-end">
            ...
            <div class="container-fluid transportback_dark">
              <br>
              <br>
              <div class="container-sm">
                <div class="row">
                    <div class="col centered">
            <h3 class="h4 mb-3 fw-normal light">Данные сохранены! </h3>
                      <br>
                      <div class="btn-group">
                          <button type="button" class="btn btn-primary" @click="$router.push('/mt')">Перейти в мой транспорт</button>
                          <button type="button" class="btn btn-danger" @click="$router.push('/cat')">Перейти в каталог</button>
                        </div>
                    </div>
